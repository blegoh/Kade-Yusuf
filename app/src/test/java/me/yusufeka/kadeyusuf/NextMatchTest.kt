...
class NextMatchTest {
    ...
    fun getNextMatch() {
        ...
        assertTrue(matchViewModel.getNextMatch().hasObservers())
        runBlocking {
            `when`(matchRepository!!.getNextMatch(ArgumentMatchers.anyInt()))
                .thenReturn(response)
    ...
    fun setUp() {
        ...
        matchViewModel.getNextMatch().observeForever(observerMatch!!)
    }
}